...
import { ArrowRight, Check, Sparkles, Terminal, Code2, Cpu, FileCode2, Play, Search, ShieldCheck, Zap, Globe, Trophy, BookOpen, Bug, CheckCircle2 } from "lucide-react";
...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-3.5rem)] bg-white text-[#37352F] selection:bg-[#2383E2]/20">
          ...
          <div className="h-10 bg-[#F7F7F5] border-b border-[rgba(55,53,47,0.09)] flex items-center px-4 justify-between select-none">
            <div className="flex items-center gap-2">
              ...
              <div className="ml-4 flex items-center gap-2 text-xs font-semibold text-[#37352F]">
                <span className="text-[11px] px-2 py-0.5 rounded bg-[#EFEFEF] flex items-center gap-1.5">
                  <NotionIcon name="python" color="yellow" size="sm" className="size-3.5 p-0 border-none bg-transparent" />
            ...
            <div className="flex items-center gap-3 text-xs text-[rgba(55,53,47,0.5)]">
              <span className="flex items-center gap-1 font-medium hover:text-black cursor-pointer">
                <Play className="size-3 text-emerald-600 fill-emerald-600" /> Run File
              </span>
              <span className="flex items-center gap-1 font-medium hover:text-black cursor-pointer">
                <NotionIcon name="chat" color="purple" size="sm" className="size-3.5 p-0 border-none bg-transparent" /> Pip AI
              </span>
              <span className="flex items-center gap-1 font-medium hover:text-black cursor-pointer">
                <NotionIcon name="star" color="yellow" size="sm" className="size-3.5 p-0 border-none bg-transparent" />
              </span>
              <span>•••</span>
            </div>
          </div>
          ...
          <div className="flex min-h-[380px] bg-white">
            ...
            <div className="w-56 bg-[#FBFBFA] border-r border-[rgba(55,53,47,0.09)] p-3 hidden sm:block text-xs">
              ...
              <div className="space-y-1.5 mb-6">
                <div className="flex items-center justify-between p-1.5 rounded bg-[#E8F3F7] text-[#1C3B47] font-semibold">
                  <span className="flex items-center gap-1.5">
                    <NotionIcon name="python" color="blue" size="sm" className="size-3.5 p-0 border-none bg-transparent" />
                    Python Mastery
                  </span>
                ...
                <div className="flex items-center justify-between p-1.5 rounded hover:bg-[#F1F1EF] text-[rgba(55,53,47,0.8)]">
                  <span className="flex items-center gap-1.5">
                    <NotionIcon name="zap" color="orange" size="sm" className="size-3.5 p-0 border-none bg-transparent" />
                    AsyncIO & FastAPI
                  </span>
                ...
                <div className="flex items-center justify-between p-1.5 rounded hover:bg-[#F1F1EF] text-[rgba(55,53,47,0.8)]">
                  <span className="flex items-center gap-1.5">
                    <NotionIcon name="ai" color="purple" size="sm" className="size-3.5 p-0 border-none bg-transparent" />
                    AI & GenAI SDKs
                  </span>
              ...
              <div className="space-y-1.5">
                <div className="flex items-center gap-2 p-1.5 rounded bg-[#F1F1EF] font-semibold text-[#37352F]">
                  <NotionIcon name="sparkles" color="purple" size="sm" />
                  Pip AI Tutor
                </div>
                <div className="flex items-center gap-2 p-1.5 rounded hover:bg-[#F1F1EF] text-[rgba(55,53,47,0.7)]">
                  <NotionIcon name="bug" color="green" size="sm" />
                  Traceback Debugger
                </div>
                <div className="flex items-center gap-2 p-1.5 rounded hover:bg-[#F1F1EF] text-[rgba(55,53,47,0.7)]">
                  <NotionIcon name="test" color="blue" size="sm" />
            ...
            <div className="flex-1 p-6 md:p-8">
              <div className="flex items-center gap-3 mb-4">
                <NotionIcon name="python" color="yellow" size="lg" className="shadow-xs border border-black/10" />
                <div>
              ...
              <div className="flex items-center gap-4 border-b border-[rgba(55,53,47,0.09)] pb-2 mb-6 text-xs text-[rgba(55,53,47,0.6)]">
                <button onClick={() => setActiveTab("exercises")} className={`font-semibold pb-2 border-b-2 transition-colors cursor-pointer flex items-center gap-1.5 ${activeTab === "exercises" ? "border-black text-black" : "border-transparent hover:text-black"}`}>
                  <NotionIcon name="document" size="sm" className="size-3.5 p-0 border-none bg-transparent" /> Practice Exercises
                </button>
                <button onClick={() => setActiveTab("sandbox")} className={`font-semibold pb-2 border-b-2 transition-colors cursor-pointer flex items-center gap-1.5 ${activeTab === "sandbox" ? "border-black text-black" : "border-transparent hover:text-black"}`}>
                  <NotionIcon name="terminal" size="sm" className="size-3.5 p-0 border-none bg-transparent" /> Python Sandbox
                </button>
                <button onClick={() => setActiveTab("leaderboard")} className={`font-semibold pb-2 border-b-2 transition-colors cursor-pointer flex items-center gap-1.5 ${activeTab === "leaderboard" ? "border-black text-black" : "border-transparent hover:text-black"}`}>
                  <NotionIcon name="trophy" size="sm" className="size-3.5 p-0 border-none bg-transparent" /> Leaderboard
                </button>
                <button onClick={() => setActiveTab("docs")} className={`font-semibold pb-2 border-b-2 transition-colors cursor-pointer flex items-center gap-1.5 ${activeTab === "docs" ? "border-black text-black" : "border-transparent hover:text-black"}`}>
                  <NotionIcon name="book" size="sm" className="size-3.5 p-0 border-none bg-transparent" /> PyPI & Docs
                </button>
              </div>
                ...
                <div className="divide-y divide-[rgba(55,53,47,0.06)]">
                  <div className="grid grid-cols-12 p-2.5 items-center hover:bg-[#FBFBFA]">
                    ...
                    <div className="col-span-3 text-[rgba(55,53,47,0.7)] flex items-center gap-1.5">
                      <NotionIcon name="user" color="yellow" size="sm" className="size-4 p-0.5 rounded-full" /> Alex M.
                    </div>
                  </div>

                  <div className="grid grid-cols-12 p-2.5 items-center hover:bg-[#FBFBFA]">
                    <div className="col-span-6 font-medium text-[#37352F] flex items-center gap-2">
                      <NotionIcon name="code" color="blue" size="sm" />
                    ...
                    <div className="col-span-3 text-[rgba(55,53,47,0.7)] flex items-center gap-1.5">
                      <NotionIcon name="user" color="blue" size="sm" className="size-4 p-0.5 rounded-full" /> Sarah T.
                    </div>
                  </div>

                  <div className="grid grid-cols-12 p-2.5 items-center hover:bg-[#FBFBFA]">
                    <div className="col-span-6 font-medium text-[#37352F] flex items-center gap-2">
                      <NotionIcon name="target" color="orange" size="sm" />
                    ...
                    <div className="col-span-3 text-[rgba(55,53,47,0.7)] flex items-center gap-1.5">
                      <NotionIcon name="ai" color="purple" size="sm" className="size-4 p-0.5 rounded-full" /> Pip Tutor
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-5xl mx-auto space-y-4">
          <div className="flex flex-wrap items-center justify-center gap-3 text-xs sm:text-sm font-extrabold text-[#37352F]">
            <span className="px-3.5 py-1.5 rounded-full border border-[rgba(55,53,47,0.12)] bg-[#FAF9F6] flex items-center gap-2 hover:border-black/30 transition-all">
              <NotionIcon name="ai" color="purple" size="sm" className="size-4 p-0 border-none bg-transparent" /> OpenAI
            </span>
            <span className="px-3.5 py-1.5 rounded-full border border-[rgba(55,53,47,0.12)] bg-[#FAF9F6] flex items-center gap-2 hover:border-black/30 transition-all">
              <NotionIcon name="sparkles" color="blue" size="sm" className="size-4 p-0 border-none bg-transparent" /> Google DeepMind
            </span>
            <span className="px-3.5 py-1.5 rounded-full border border-[rgba(55,53,47,0.12)] bg-[#FAF9F6] flex items-center gap-2 hover:border-black/30 transition-all">
              <NotionIcon name="code" color="gray" size="sm" className="size-4 p-0 border-none bg-transparent" /> Cursor
            </span>
            <span className="px-3.5 py-1.5 rounded-full border border-[rgba(55,53,47,0.12)] bg-[#FAF9F6] flex items-center gap-2 hover:border-black/30 transition-all">
              <NotionIcon name="rocket" color="pink" size="sm" className="size-4 p-0 border-none bg-transparent" /> Vercel
            </span>
            <span className="px-3.5 py-1.5 rounded-full border border-[rgba(55,53,47,0.12)] bg-[#FAF9F6] flex items-center gap-2 hover:border-black/30 transition-all">
              <NotionIcon name="cpu" color="green" size="sm" className="size-4 p-0 border-none bg-transparent" /> NVIDIA
            </span>
            <span className="px-3.5 py-1.5 rounded-full border border-[rgba(55,53,47,0.12)] bg-[#FAF9F6] flex items-center gap-2 hover:border-black/30 transition-all">
              <NotionIcon name="book" color="yellow" size="sm" className="size-4 p-0 border-none bg-transparent" /> Stanford
            </span>
            <span className="px-3.5 py-1.5 rounded-full border border-[rgba(55,53,47,0.12)] bg-[#FAF9F6] flex items-center gap-2 hover:border-black/30 transition-all">
              <NotionIcon name="trophy" color="orange" size="sm" className="size-4 p-0 border-none bg-transparent" /> MIT
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5 text-xs font-semibold text-[rgba(55,53,47,0.65)]">
            <span className="px-3 py-1 rounded-md bg-[#F7F7F5] border border-black/5 flex items-center gap-1.5">
              <NotionIcon name="python" color="yellow" size="sm" className="size-3.5 p-0 border-none bg-transparent" /> PyPI
            </span>
            <span className="px-3 py-1 rounded-md bg-[#F7F7F5] border border-black/5 flex items-center gap-1.5">
              <NotionIcon name="zap" color="blue" size="sm" className="size-3.5 p-0 border-none bg-transparent" /> FastAPI
            </span>
            <span className="px-3 py-1 rounded-md bg-[#F7F7F5] border border-black/5 flex items-center gap-1.5">
              <NotionIcon name="layers" color="green" size="sm" className="size-3.5 p-0 border-none bg-transparent" /> Django
            </span>
            <span className="px-3 py-1 rounded-md bg-[#F7F7F5] border border-black/5 flex items-center gap-1.5">
              <NotionIcon name="flame" color="orange" size="sm" className="size-3.5 p-0 border-none bg-transparent" /> PyTorch
            </span>
            <span className="px-3 py-1 rounded-md bg-[#F7F7F5] border border-black/5 flex items-center gap-1.5">
              <NotionIcon name="cpu" color="purple" size="sm" className="size-3.5 p-0 border-none bg-transparent" /> NumPy
            </span>
            <span className="px-3 py-1 rounded-md bg-[#F7F7F5] border border-black/5 flex items-center gap-1.5">
              <NotionIcon name="database" color="pink" size="sm" className="size-3.5 p-0 border-none bg-transparent" /> Pandas
            </span>
          </div>
        </div>
      </section>
          ...
          <div className="bg-[#F7F7F5] border border-[rgba(55,53,47,0.08)] rounded-2xl p-8 flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <div className="bg-white border border-[rgba(55,53,47,0.12)] rounded-xl p-5 shadow-xs space-y-4">
              <div className="flex items-center gap-2 font-bold text-base text-[#37352F]">
                <NotionIcon name="bug" color="purple" size="md" /> Python Traceback Assistant
              </div>
              <div className="flex items-center gap-2 text-xs text-[rgba(55,53,47,0.5)]">
                <span className="notion-tag notion-tag-purple flex items-center gap-1">
                  <NotionIcon name="shield" color="purple" size="sm" className="size-3 p-0 border-none bg-transparent" /> TypeError
                </span>
                <span className="notion-tag notion-tag-gray flex items-center gap-1">
                  <NotionIcon name="code" color="gray" size="sm" className="size-3 p-0 border-none bg-transparent" /> line 42
                </span>
              </div>
          ...
          <div className="bg-[#F7F7F5] border border-[rgba(55,53,47,0.08)] rounded-2xl p-8 flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <div className="bg-white border border-[rgba(55,53,47,0.12)] rounded-xl p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 font-bold text-base text-[#37352F]">
                  <NotionIcon name="book" color="green" size="md" /> FastAPI & Pydantic v2 Cheat Sheet
                </div>
      ...
      <section className="px-6 py-12 max-w-6xl mx-auto w-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          <Link href="/sandbox" className="border border-[rgba(55,53,47,0.12)] rounded-xl p-4 bg-white hover:border-black/30 transition-all cursor-pointer group flex flex-col justify-between h-32">
            <NotionIcon name="bug" color="red" size="md" />
          ...
          <Link href="/courses" className="border border-[rgba(55,53,47,0.12)] rounded-xl p-4 bg-white hover:border-black/30 transition-all cursor-pointer group flex flex-col justify-between h-32">
            <NotionIcon name="test" color="blue" size="md" />
            <div className="font-semibold text-xs text-[#37352F] group-hover:underline flex items-center gap-1">
      ...
      {/* Section 4: Trusted By Engineers and Teams with Developer Accents */}
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-[#8B2626] text-white rounded-2xl p-8 flex flex-col justify-between min-h-[380px] shadow-lg relative overflow-hidden group">
            <div className="absolute top-4 right-4 opacity-10 group-hover:opacity-20 transition-opacity">
              <NotionIcon name="user" color="gray" size="xl" className="size-24 bg-transparent border-none text-white" />
            </div>
            ...
            <div className="relative z-10 flex items-center gap-3 pt-6 border-t border-white/15">
              <NotionIcon name="user" color="pink" size="md" className="bg-white/10 border-white/20 text-white" />
              <div>
          ...
          <div className="bg-[#1B4965] text-white rounded-2xl p-8 flex flex-col justify-between min-h-[380px] shadow-lg relative overflow-hidden group">
            <div className="absolute top-4 right-4 opacity-10 group-hover:opacity-20 transition-opacity">
              <NotionIcon name="ai" color="gray" size="xl" className="size-24 bg-transparent border-none text-white" />
            </div>
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-8">
            ...
            <div className="relative z-10 flex items-center gap-3 pt-6 border-t border-white/15">
              <NotionIcon name="user" color="blue" size="md" className="bg-white/10 border-white/20 text-white" />
              <div>
          ...
          <div className="bg-[#8C5A14] text-white rounded-2xl p-8 flex flex-col justify-between min-h-[380px] shadow-lg relative overflow-hidden group">
            <div className="absolute top-4 right-4 opacity-10 group-hover:opacity-20 transition-opacity">
              <NotionIcon name="sparkles" color="gray" size="xl" className="size-24 bg-transparent border-none text-white" />
            </div>
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-8">
            ...
            <div className="relative z-10 flex items-center gap-3 pt-6 border-t border-white/15">
              <NotionIcon name="user" color="orange" size="md" className="bg-white/10 border-white/20 text-white" />
              <div>
      ...
      {/* Metrics Ticker Row with Vector NotionIcons */}
      <section className="border-y border-[rgba(55,53,47,0.08)] bg-[#FAF9F6] py-6 px-6 overflow-hidden select-none">
        <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-between gap-6 text-xs font-semibold text-[rgba(55,53,47,0.8)]">
          <span className="flex items-center gap-2">
            <NotionIcon name="globe" color="blue" size="sm" /> 500K+ Python Developers
          </span>
          <span className="flex items-center gap-2">
            <NotionIcon name="zap" color="yellow" size="sm" /> 15M+ Code Executions
          </span>
          <span className="flex items-center gap-2">
            <NotionIcon name="ai" color="purple" size="sm" /> 99.8% AI Bug Correction Rate
          </span>
          <span className="flex items-center gap-2">
            <NotionIcon name="book" color="green" size="sm" /> 120+ Interactive Python Courses
          </span>
          <span className="flex items-center gap-2">
            <NotionIcon name="trophy" color="orange" size="sm" /> #1 Python AI Workspace on G2
          </span>
        </div>
      </section>
      ...
      <section className="px-6 py-28 text-center bg-[#F7F7F5] border-t border-[rgba(55,53,47,0.09)]">
        <div className="max-w-xl mx-auto">
          <div className="inline-flex items-center gap-2 mb-6">
            <NotionIcon name="python" color="yellow" size="lg" className="shadow-xs" />
            <NotionIcon name="sparkles" color="purple" size="lg" className="shadow-xs" />
          </div>
